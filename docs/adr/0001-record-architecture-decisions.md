...
The report and the defense can cite a dated rationale instead of reconstructing one after
the fact. An ADR is superseded by a later ADR rather than edited, so the reasoning trail
stays intact even when a decision is reversed.
